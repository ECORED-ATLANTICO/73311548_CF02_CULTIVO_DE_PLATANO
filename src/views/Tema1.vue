    ...
    .mb-3
      ...
      TabsB.color-acento-contenido.mb-5
        ...
        .py-4.py-md-5(titulo="Importancia del control temprano" :icono="require('@/assets/curso/temas/tema1/img_5.svg')")
          .row.justify-content-center.align-items-center
            ...
            .col-md-6
              figure
                  img(src='@/assets/curso/temas/tema1/img_6.svg', alt='Imagen de un suelo con césped' class="img-fluid")
      ...
      .row.justify-content-center.align-items-center.mb-5
        .col-lg-10.mb-2
          ...
          object(:data="figura3" type="image/svg+xml" class="img-fluid").mb-0
      ...
      .row.justify-content-center.align-items-center
        ...
        .col-lg-3
          figure
            img.mb-5(src="@/assets/curso/temas/tema1/img_44.svg", alt="Manejo fitosanitario" class="img-fluid")
</template>
