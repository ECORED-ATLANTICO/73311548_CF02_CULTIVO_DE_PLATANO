...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-3
        img(src="@/assets/curso/temas/tema3/img_1.svg", alt="Imagen de unos platanos" class="img-fluid")
      .col-lg-9
        ...
        .tarjeta_bg-06.p-4.mb-2
          .row.mb-3.justify-content-center.align-items-center
            .col-lg-1
              img(src="@/assets/curso/temas/tema3/img_2.svg", alt="Imagen de unos platanos" class="img-fluid")
            .col-lg-11
