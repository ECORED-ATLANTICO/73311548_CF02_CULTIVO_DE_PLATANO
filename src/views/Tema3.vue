            ...
            .col-lg-6
              .tarjeta_bg-04.mb-2.height-100
                .row.ordenar_tarjeta_lg.p-5.align-items-center
                  ...
                  .col-sm-3.col-md-3.col-lg-3.col-xl-3.col-xxl-3.pos_2
            ...
            .col-lg-6
              .tarjeta_bg-05.mb-2.height-100
                .row.ordenar_tarjeta_lg.p-5.align-items-center
                  ...
                  .col-sm-3.col-md-3.col-lg-4.col-xl-3.col-xxl-3.pos_2
      ...
      .row.justify-content-center.align-items-center.mb-5
        .col-lg-9
          ...
          .tarjeta_bg-06.p-4.mb-2
            ...
            ol(style="list-style-type: lower-alpha").p-3
              li.mb-2 Después de cada uso, los tanques deben vaciarse completamente.
              li.mb-2 Se debe añadir detergente y restregar las superficies para eliminar la suciedad acumulada.
        ...
        .col-10.col-sm-10.col-md-10.col-lg-10.col-xl-10.col-xxl-10.mb-3
          ...
          SlyderA(tipo="b").custom-slider-a-b.rounded-4
            ...
            .row.align-items-center.custom-slider-a-b__item
              ...
              .d-none.d-lg-block.col-lg-6
                figure
                  img(src='@/assets/curso/temas/tema3/img_27.png', alt='young-selectionist')
            ...
            .row.align-items-center.custom-slider-a-b__item
              ...
              .d-none.d-lg-block.col-lg-6
                figure
                  img(src='@/assets/curso/temas/tema3/img_28.png', alt='Imagen decorativa')
</template>
